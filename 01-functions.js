...
function averageThree(a,b,c) {
  return ((a + b + c)/ 3)
  //const sum = averageThree((10 + 11 + 19) / 3)
}
...
function joinStringsWithSpaces(a,b,c,d,e) {
  return ('A' + ' ' + 'B' + ' ' + 'C' + ' ' + 'D' + ' ' + 'E')
  //return `${a,b,c,d,e}`
//const strings = joinStringsWithSpaces("left", "right", "up", "down", "away")
}
...
function getFirstAndLastCharacter(a) {
  ...
  //return(charAt())
  //return(str.length -1)
//const string = getFirstAndLastCharacter(string.charAt(0), str.length-1)
}
