...
function shoutForLoop(array) {
  //intiate accumulator which is a new array
  let shoutArray = [];
  //begin loop
...
function findSmallest(array) {
  //creat accumulator - looking for the ouput of the number of the array which is an index of the array
...
function findLargest(array) {
  //create accumulator - we are looking for an output of number of the array which is an index of the array
...
function removeDuplicates(array) {
  //initalize accumulator - ouput is new arrayt
  let dupArr = [];
  for (let number of array) {
    //Check to see if the the new array does NOT include the number of the orginal array
    if (!dupArr.includes(number)) {
      //then push the number to the new array
      dupArr.push(number);
    }
  }
  return dupArr;
