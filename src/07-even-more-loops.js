...
function shoutForLoop(array) {
  ...
  for(i=0; i < array.length; i++){
    let x = array[i] + "!" //declared variable for element then added string
    newArr.push(x)
    //
  }
  return newArr;
...
function shoutWhileLoop(array) {
  ...
  while(i < array.length){
    let x = array[i] + "!"
    newArr.push(x) 
    i++; // increment goes inside the loop
  }
...
function shoutForOfLoop(array) {
  let newArr = [];
    ...
    for(let point of array){ //point = array[i]
      newArr.push(`${point}!`);
  }
  return newArr;
}
...
let newArr = [];
  for(let i =0; i < array.length; i++){
    if(array[i] % 2 === 1){
      newArr.push(array[i]) // target the element of array into new array
    }
  }
  return newArr;
}
...
let smallest = array[0]
  for(let i = 0; i < array.length; i++){
    if(smallest > array[i]){
    smallest = array[i]; //redeclared smallest
    }
  }
  return smallest
}
...
function findLargest(array) {
  ...
  for(let i = 0; i < array.length; i++){
    if(largest < array[i]){
    largest = array[i]; //redeclared largest
    }
  }
  return largest;
}
 ...
 * removeDuplicates()
 * ---------------------
 * Returns a new array like the original array except there are no duplicates. 
 * The numbers in the array should be ordered similarly.
 *
...
function removeDuplicates(array) {
  ...
  if(!newArr.includes(array[i])){ //if the new array doesnt include value from old array
    newArr.push(array[i])
}
  }
return newArr;  
