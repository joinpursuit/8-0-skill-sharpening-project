...
function findSmallest(array) {
  let smallest = array[0]// start at beginning of array to compare the next iterations
  for(let i = 0; i < array.length; i++){
    if (array[i] < smallest){
      smallest = array[i];// smallest gets replaced by the smaller of the 2 compared #s and then checks the next # till the end
    }
  }
  return smallest
}
...
function findLargest(array) {
  let biggest = array[0]// start at beginning of array to compare the next iterations
  for(let i = 0; i < array.length; i++){
    if (array[i] > biggest){
      biggest = array[i];// biggest gets replaced by the bigger of the 2 compared #s and then checks the next # till the end
    }
  }
  return biggest
}
...
function removeDuplicates(array) {
  ...
  for(let number of array){
    if (newArray.includes(number) === false){   // or i can write if (!newArray.includes(num)
