...
function shoutForLoop(array) {
  const newArr = [];
  for (i = 0; i < array.length; i++) { newArr.push(array[i] + `!`); }
  return newArr;
}
...
function shoutWhileLoop(array) {
  const newArr = [];
  let i = 0;
  while (i < array.length) { newArr.push(array[i] + `!`); i++; }
  return newArr;
}
...
function shoutForOfLoop(array) {
  const newArr = [];
  for (const elem of array) { newArr.push(elem + `!`); }
  return newArr;
}
...
function sumArray(array) {
  let sum = 0;
  for (const elem of array) { sum += elem; }
  return sum;
}
...
function findSmallest(array) {
  ...
  for (const elem of array) {
    if (elem < smallestNum) { smallestNum = elem };
  }
  return smallestNum;
}
...
function findLargest(array) {
  ...
  for (const elem of array) {
    if (elem > biggestNum) { biggestNum = elem };
  }
  return biggestNum;
}
