 ...
 *  //> { whateverKey: 19 }
 */
function createObjectWithValue(val) {return {abc:val}}
 ...
 *  //> { left: false }
 */
function createObjectWithKey(key) {return JSON.parse(`{"${key===undefined?"undefined":key}":false}`)}
 ...
 *  //> 30
 */
function getAgeFromObject(object) {return object['age']}
