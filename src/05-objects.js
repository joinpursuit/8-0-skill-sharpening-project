...
// console.log(createObjectWithValue(`hello`));
...
// console.log(createObjectWithKey(`isTired`));
...
// console.log(createObjectWithKeyValuePair(`greeting`, `good morning`));
...
// console.log(addValueToObject({ left: true }, `yes`));
