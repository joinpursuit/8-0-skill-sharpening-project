 ...
 *  //> { left: false }
 */
function createObjectWithKey(key) { //Why is thing the only solution that works??? // tried to create new obj and failed :/ 
  createObjectWithKey[key] = "SOMETHING"
 return createObjectWithKey
}
