...
function createObjectWithValue(val) {
  let theObjWithVal = {Key:val};
  return theObjWithVal;
}
...
function createObjectWithKey(key) {
  let theObjWithKey = {};
   theObjWithKey[key] = "Val";
   return theObjWithKey;
}
...
function createObjectWithKeyValuePair(key, val) {
  let theObjWithKeyPair = {};
  theObjWithKeyPair[key] = val;
  return theObjWithKeyPair;
}
