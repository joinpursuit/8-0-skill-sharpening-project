...
function timesIndex(array) {
  returnOfTheArray = [];
  for (let i = 0; i < array.length; i++){
    returnOfTheArray.push(array[i] * i);
  }
  return returnOfTheArray;
}
...
function cumulativeSum(array) {
  ...
  for (let i = 0; i < array.length; i++){
    if (i == 0){
      value = array[i];
      thatSumArray.push(array[i]);
    } else {
      thatSumArray.push((array[i] + value));
      value = thatSumArray[i];
    }      
  }
  console.log(thatSumArray);
  return thatSumArray;
}
