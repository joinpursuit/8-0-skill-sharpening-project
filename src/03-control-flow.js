...
function findLargerOrTie(a, b) {
  if(a > b) {
    ...
    else if(a >= b) { // used greater than or equal to instead of ===
    return 'tie';
    }
}
...
function positiveNegativeOrZero(a) {
  ...
  else if(a < 0){ //numbers less than zero are negative
    return "Negative";
  }
  else if(a > 0){ // numbers greater than zero are positive
    return "Positive";
  }
}
...
function aroundTheWorldGreetingWithSwitch(language) {
  switch(language){
    case "english": //switch cases need colons after the expression/statement
    return "Hello World"
    break;
    case "spanish":
    return "Hola Mundo"
...
function evenOrOddWithTernary(a) {
  return (a % 2 === 0) ? "Even" : "Odd"; //you forgot to type return lol
}                      //if       else
