const { isEven, isOdd } = require("./02-data-types")
 ...
 *  //> "1 pig"
 */
// return string with animal name and a number with the animal count
function animalCounts(animal, numberOfAnimals) {
  let animalCount = 0;
    for (let element = 0; element < animal.length; element++) {
       if (animal.charAt(element) === numberOfAnimals) 
         {
         animalCount += 1;
         }
     }
