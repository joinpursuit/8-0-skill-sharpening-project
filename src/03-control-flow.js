...
//takes in a language
const languagesArr = ['english', 'spanish', 'german']

if (language !== undefined && !languagesArr.includes(language))
 return "Make sure the language you choose is English, Spanish, or German.";
...
function aroundTheWorldGreetingWithSwitch(language) {
  const validLanguages = ["english", "spanish", "german"];

  if (language !== undefined && !validLanguages.includes(language)) return "Make sure the language you choose is English, Spanish, or German.";
  if (language === undefined) language = "english";
...
function calculateLetterGrade(grade) {
  return grade > 89 ? "A" : grade > 79 ? "B" : grade > 69 ? "C" : grade > 59 ? "D" : "F";
}
