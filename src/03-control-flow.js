...
function aroundTheWorldGreetingWithSwitch(language) {
  switch(language) {
    case "spanish" : return "Hola Mundo"; break;
    case "german" : return "Hallo Welt"; break;
    case "english" : return "Hello World"; break;
    default : return "Hello World"; break;
  }
}
...
function calculateLetterGrade(grade) {
  switch (true) {
    case grade >= 90 : return "A"; break;
    case grade >= 80 : return "B"; break;
    case grade >= 70 : return "C"; break;
    case grade >= 60 : return "D"; break;
...
function animalCounts(animal, numberOfAnimals) {
  if(numberOfAnimals > 1) return `${numberOfAnimals} ${animal}s`;
