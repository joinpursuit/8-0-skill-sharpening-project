...
//console.log(positiveNegativeOrZero(-64))
...
function animalCounts(animal, numberOfAnimals) {
  ...
  }//`${numberOfAnimals} ${animal}s` is the same code as above.
};
...
};//code above is exactly same as code below
/* if (a % 2 === 0) {
   return "Even"
 } else {
   return "Odd"
