 ...
 *           (random num)
 * SCORING: if grade is 90 and above return A
 *          
 *          if grade is 80 and above return B
 *          if grade is 70 and above return C
 *          if grade is 60 and above return D
 *          else Anything lower than 60 return F
 * @param {number} grade
 * @returns {string}
 *
 * EXAMPLE:
