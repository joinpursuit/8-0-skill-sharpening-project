...
function convertToShoutingText(text) {
  ...
  // convert text into all uppercase letters
...
function convertToWhisperText(text) {
  // convert text into all lowercase letters

  let character = text.toLowerCase()
...
function checkIfCharacterIsInString(text, character) {
  // checks if a character appears in the text
