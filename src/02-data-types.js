...
function convertToShoutingText(text) {
  let convertedUpper = text.toUpperCase()
...
function convertToWhisperText(text) {
  let convertedLower = text.toLowerCase()
  return convertedLower
}
...
function checkIfCharacterIsInString(text, character) {
  let characterCheck = text.includes(character)
