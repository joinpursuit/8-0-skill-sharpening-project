 ...
 * Make sure you return a different empty array each time the 
 * function is called.
 * You can do this by returning an empty array that is created 
 ...
 * ---------------------
 * Adds an `element` to the end of the inputted `array`. Then, 
 * returns the array.
 * @param {*[]} array
 * @param {*} element
 * @returns {*[]}
