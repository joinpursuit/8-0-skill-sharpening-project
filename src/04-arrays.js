...
function getMiddleElement(array) {
  let middleElement = array[Math.floor(array.length/2)] // Math.floor will return the largest integer < or = to a given number (in this case is equal to array.length divided by 2)
