...
// console.log(createArrayWithTwoElements(`Hey`, `Dan`));
...
// console.log(getArrayLength([1, 2, 3, 4, 5, 10]));
...
// console.log(addElementToEndOfArray([ 10, 16 ], 92));
...
// console.log(removeElementFromEndOfArray([10, 16, 92]));
...
// console.log(addElementToFrontOfArray([ 16, 92 ], 10));
...
// console.log(removeElementFromFrontOfArray([ 16, 10, 92 ]));
...
// console.log(getMiddleElement([ 10, 16, 92, `middle`, 92, 16, 10 ]));
