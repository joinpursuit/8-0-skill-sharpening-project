...
function getArrayLength(array) {
  return array.length;
  //* means it could be any data type
}
...
function removeElementFromEndOfArray(array) {
  return array.pop()//pop take the element and returns it.
}
...
function getMiddleElement(array) {
  let midIndex = Math.floor(array.length/2);//math.length removes decimals
