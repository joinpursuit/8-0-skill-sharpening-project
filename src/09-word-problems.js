...
for (i = 0; i <= products.length-1; i++){
  total =total + (products[i].priceInCents*products[i].quantity);
}
total = total /100;
...
for (i=0; i <= assignments.length-1;i++){
  ...
  if (assignments[i].kind === "PASS-FAIL" && assignments[i].score.received === assignments[i].score.max){
    // console.log(assignments[i].score.max);
    assignments[i].status = "PASSED";
     ...
     else if (assignments[i].kind === "PERCENTAGE" && assignments[i].score.received/assignments[i].score.max >= 0.80){
      assignments[i].status = `PASSED: ${(assignments[i].score.received/assignments[i].score.max*100).toFixed(1)}%`;
      //console.log(assignments[i].score.received/assignments[0].score.max*100);
      } 
