...
function getFlatObject(person) {
  ...
  flattenObj.first = person.names.first;
  flattenObj.middle = person.names.middle;
  flattenObj.last = person.names.last;
  flattenObj.street = person.address.street;
  flattenObj.unit = person.address.unit;
  flattenObj.city = person.address.city;
  flattenObj.state = person.address.state;
  flattenObj.zip = person.address.zip;
  flattenObj.numbers = person.numbers;
