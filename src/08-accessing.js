...
function getFlatObject(person) {
  let info = {}
  info.first = person.names.first
  info.middle = person.names.middle
  info.last = person.names.last
  info.street = person.address.street
  info.unit = person.address.unit
  info.city = person.address.city
  info.state = person.address.state
  info.zip = person.address.zip
  info.numbers = person.numbers
  return info
}
