...
function getCountOfPhoneNumbers(person) {
  ...
  let phoneCount = 0
    ...
    phoneCount = person.numbers.length
...
function getFullName(person) {
  ...
  fullName = `${person.names.first} ${person.names.middle} ${person.names.last}`
...
function getCityAndState(person) {
  ...
  cityState = `${person.address.city}, ${person.address.state}`
...
function getFullAddress(person) {
  ...
  fullAddress = 
 `${person.address.street} ${person.address.unit}, ${person.address.city}, ${person.address.state}, ${person.address.zip}`
