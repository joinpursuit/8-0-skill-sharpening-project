 ...
 * getFlatObject()
 * ---------------------
 * Create a new object where all of the keys from the 
 * `names` and `address` objects are in the same object. 
...
//create a new object ; splat operator (spread syntax)...method; objClone = { ...obj} ; splat is just a ... ; 
// numbers:person.numbers is used to access the key numbers and then accesses the values within that key (numbers)
