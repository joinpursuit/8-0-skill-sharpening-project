...
function getFullName(person) {
  return `${person.names.first} ${person.names.middle} ${person.names.last}`; //no need for '+' sign in interpolation
}
...
//   let finalObject = {};
//   finalObject = Object.assign(newObj, person.names);
//   finalOject = Object.assign(newObj, person.address);
//   finalObject = delete person.names;
//   finalObject = delete person.address;
//   finalObject = Object.assign(newObj, person);
