...
let allkeys = {};
  allkeys.first = person.names.first;
  allkeys.middle = person.names.middle;
  allkeys.last = person.names.last;
  allkeys.street = person.address.street;
  allkeys.unit = person.address.unit;
