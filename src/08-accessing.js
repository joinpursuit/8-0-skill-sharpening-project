...
function getFlatObject(person) {
  let x= {};
  x.first= person.names.first;
  x.middle= person.names.middle;
  x.last= person.names.last;
  x.street= person.address.street;
  x.unit= person.address.unit;
  x.city= person.address.city;
  x.state= person.address.state;
  x.zip= person.address.zip;
  x.numbers= person.numbers;
  return x;
}
