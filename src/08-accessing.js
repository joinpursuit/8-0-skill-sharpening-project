...
function getFullAddress(person) {
  const addrsArr = Object.values(person.address);
  return `${addrsArr[0]} ${addrsArr[1]}, ${addrsArr[2]}, ${addrsArr[3]}, ${addrsArr[4]}`;
}
...
function getFlatObject(person) {
  const flatObj = {};
  Object.assign(flatObj, person.names, person.address);
