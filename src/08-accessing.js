...
function getFullName(person) {
  person.fullName = person.names.first + ' ' + person.names.middle + ' ' + person.names.last;
...
function getCityAndState(person) {
  person.cityState = person.address.city + ', ' + person.address.state; 
  return person.cityState;
}
...
function getFullAddress(person) {
  person.fullAddress = person.address.street + ' ' + person.address.unit + ', '+ person.address.city + ', ' + person.address.state + ', ' + person.address.zip;
