/*
  For all of the functions below, assume each function takes the following 
  `person` object as its input. While the values of the object may change, 
...
function getLastName(person) {
  return person.names.last.toString();
}
...
function getAddressStreet(person) {
  return person.address.street.toString();
}
