 ...
 */
function averageThree(numA, numB, numC) {
  let numAverage = (numA+numB+numC)/3 ;
  return numAverage;
}
 ...
 *  //> false
 */
function compareTypes(valueA, valueB) {
